...
public class Utils implements Const{
	...
	*/
	...
	/**
	 * Decrypt "Password locked PDF" to "Plain PDF"
	 * @param inputFile
	 * @param output
	 * @param userPassowrd
	 * @throws Exception
	 */
	public static void decryptPdf(String inputFile, FileOutputStream output, byte[] userPassowrd) 
		throws Exception
	{
		...
		pdfFile.decrypt(new File(inputFile), output, userPassowrd, null, false);
