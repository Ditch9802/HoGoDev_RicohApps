...
public class PrintColorUtil{
     ...
     * @return
     */
    public static String getPrintColorResourceString(Context context, PrintColor printColor){
        String ret = null;
//        String ret = context.getString(R.string.color_color);
     ...
     *         PrintColor object
     */
    public static PrintColor getPrintColorFromResourceString(Context context, String colorValue) {
