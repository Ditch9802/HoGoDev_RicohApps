...
public class PrintSettingDataHolder {
    ...
    private PageTray mSelectedPageTrayValue;
    
    private PaperSide mSelectedPaperSideValue;
    ...
    public void setSelectedPageTrayValue(PageTray pageSource){
        mSelectedPageTrayValue = pageSource;
    }

    public void setSelectedPaperSideValue(PaperSide paperSide){
        mSelectedPaperSideValue = paperSide;
    }
    ...
    public PageTray getSelectedPageTrayValue(){
        return mSelectedPageTrayValue;
    }
    
    public PaperSide getSelectedPaperSideValue(){
        return mSelectedPaperSideValue;
    }
